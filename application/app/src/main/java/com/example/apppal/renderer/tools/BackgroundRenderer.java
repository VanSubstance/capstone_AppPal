...
public class BackgroundRenderer {
   ...
   * during a {@link ArRenderer.Renderer} callback, typically in {@link
   * ArRenderer.Renderer#onSurfaceCreated()}.
   */
  public BackgroundRenderer(ArRenderer render) {
    cameraColorTexture =
        new Texture(
            render,
   ...
   */
  public void setUseDepthVisualization(ArRenderer render, boolean useDepthVisualization)
      throws IOException {
   ...
   */
  public void setUseOcclusion(ArRenderer render, boolean useOcclusion) throws IOException {
  ...
  public void updateCameraDepthTexture(Image image) {
    // ArRenderer abstraction leaks here
   ...
   */
  public void drawBackground(ArRenderer render) {
  ...
  public void drawVirtualScene(
      ArRenderer render, Framebuffer virtualSceneFramebuffer, float zNear, float zFar) {
