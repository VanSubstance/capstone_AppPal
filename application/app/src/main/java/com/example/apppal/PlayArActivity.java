...
import com.example.apppal.renderer.tools.PlaneRenderer;
import com.example.apppal.renderer.tools.Shader;
import com.example.apppal.renderer.tools.SpecularCubemapFilter;
import com.example.apppal.renderer.tools.Texture;
import com.example.apppal.renderer.tools.VertexBuffer;
 ...
 */
public class PlayArActivity extends AppCompatActivity implements ArRenderer.Renderer {

    private static final String TAG = PlayArActivity.class.getSimpleName();
