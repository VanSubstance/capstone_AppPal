 ...
 *
 * <p>To render the mesh, use {@link ArRenderer#draw()}.
 */
public class Mesh implements Closeable {
   ...
   * (location 2, vec3).
   */
  public static Mesh createFromAsset(ArRenderer render, String assetFileName) throws IOException {
