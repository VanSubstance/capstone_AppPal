...
public class SpecularCubemapFilter implements Closeable {
   ...
   */
  public SpecularCubemapFilter(ArRenderer render, int resolution, int numberOfImportanceSamples)
      throws IOException {
  ...
  private Shader[] createShaders(ArRenderer render, ChunkIterable chunks) throws IOException {
