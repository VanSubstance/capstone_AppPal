...
public class PlaneRenderer {
   ...
   * a {@link ArRenderer.Renderer} callback, typically in {@link
   * ArRenderer.Renderer#onSurfaceCreated}.
   */
  public PlaneRenderer(ArRenderer render) throws IOException {
    Texture texture =
  ...
  public void drawPlanes(
    ArRenderer render, Collection<Plane> allPlanes, Pose cameraPose, float[] cameraProjection) {
